...
# CUDA_VISIBLE_DEVICES=6 python dendSOM_baseline.py -u 10 -v 0.5 -va 0.9 -r 1.5 -lr 0.07 -fp dendSOM-trial-2 -d mnist -tr 8 -tlr 45 -n 16 -ps 7 &
CUDA_VISIBLE_DEVICES=3 python dendSOM_cifar.py -u 25 -v 0.5 -va 0.9 -r 1.5 -lr 0.07 -fp cifar-dendSOM-trial-2 -d cifar-10 -tr 8 -tlr 45 -n 3 -ps 32 &
